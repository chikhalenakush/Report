...
\clearpage
\section{Conclusion}
OpenDiabetesVault Framework is widely used in TK lab to generate, upload and filter huge amount of medical data. Due to huge demand of data from various sources for data analysis, modules such as Data gathering from different sources takes more weightage in implementing the program. This generated and filtered data will be further processed with the help of Machine learning mechanism to generate logical conclusion. 
